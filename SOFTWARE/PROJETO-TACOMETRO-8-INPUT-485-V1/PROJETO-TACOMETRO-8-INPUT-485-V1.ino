...
void setup() {
   ...
   temp = 8000; //the range microseconds 
   Serial.begin   (9600);
...
/*  
CRIAR METODO PARA DEFINIR QUAL I/O IRÁ RESPONDER VIA SERIAL
USANDO 3 ENTRADAS DIGITAIS COMO MEIO DE COMUNICAÇÃO
NÃO PODE USAR UMA REDE 232 POR CONTA DA INTERRUPÇÃO ESTÁ OCUPADA MONITORANDO AS PORTAS

Se entradas digitais são: B0:B1:B2
PARA VERIFICAR SE TEM CLIENTE NA REDE
SE B0=B1=0 E  TIMEOUT >2000 ENTÃO UNICO CLIENTE NA REDE!
jamper de terminação do final da rede
